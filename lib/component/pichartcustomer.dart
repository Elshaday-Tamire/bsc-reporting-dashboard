...
class CustomerPiehart extends StatefulWidget {
  const CustomerPiehart({Key key}) : super(key: key);

  @override
  State<CustomerPiehart> createState() => _CustomerPiehartState();
}

enum LegendShape { circle, rectangle }

class _CustomerPiehartState extends State<CustomerPiehart> {
  final dataMap = <String, double>{
    "Customer": Dashboard.customertotalscore * 100 / Dashboard.customerlWaight,
    "Financial":
  ...
  final legendLabels = <String, String>{
    ...
    "Financial": "Financial legend",
    "Internal Business Process": "Internal Business Process legend",
    "Learning and Growth": "Learning and Growth legend",
  };
  ...
  Widget build(BuildContext context) {
    final chart = PieChart(
      ...
      centerText: _showCenterText ? "Perpectives" : null,
